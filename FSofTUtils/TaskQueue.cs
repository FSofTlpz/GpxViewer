...
namespace FSofTUtils {
   ...
   public class TaskQueue : IDisposable {
      ...
      /// </summary>
      public int PossibleTasks => semaphore != null ? semaphore.CurrentCount : 0;
      ...
      /// <summary>
      /// wird mit einem Text gesetzt, wenn in einem Thread eine Exception auftritt
      /// </summary>
      public string ExeptionMessage { get; private set; } = string.Empty;
      ...
      public void StartTask<TDAT1, TDAT2, TDAT3, TDAT4, TDAT5, TPROGRESS, TEND>(TDAT1 taskdata1,
                                                                         TDAT2 taskdata2,
                                                                         TDAT3 taskdata3,
                                                                         TDAT4 taskdata4,
                                                                         TDAT5 taskdata5,
                                                                         Func<TDAT1, TDAT2, TDAT3, TDAT4, TDAT5, CancellationToken, IProgress<TPROGRESS>?, TEND> taskworker,
                                                                         IProgress<TPROGRESS>? taskprogress = null,
                                                                         Action<TEND>? taskend = null) {
         taskPre();
         Task t = Task.Run(() => {
            TEND result = taskworker(taskdata1, taskdata2, taskdata3, taskdata4, taskdata5, CancellationtokenSource.Token, taskprogress);
            taskend?.Invoke(result);   // über das Ende und das Ergebnis informieren
            taskPost();
         });
      }
      ...
      public void Cancel(bool throwOnFirstException = true) => CancellationtokenSource.Cancel(throwOnFirstException);
      ...
      /// </summary>
      /// <returns></returns>
      public void Wait4EmptyQueue() => mre.Wait();

      #region Prozessor-Anzahl
