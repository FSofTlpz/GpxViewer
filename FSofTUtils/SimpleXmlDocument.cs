...
namespace FSofTUtils {
   ...
   public class SimpleXmlDocument2 : XmlDocument {
      ...
      /// <summary>
      /// registriert die im Dokument angegebenen Namespaces
      /// </summary>
            ...
            if (node is XmlElement) {
               ...
               if (elem.HasAttributes) {
                  foreach (XmlAttribute attr in elem.Attributes) {
                     ...
                     if (nsnameidx > 0) {
                        string nsname = attr.Name.Substring(nsnameidx + 1);
                        if (nsname != "")
                           AddNamespace(nsname, attr.Value);
                     }
                  }
               }
               break;
      ...
      /// <summary>
      /// liefert eine Liste der akt. registrierten Namespaces
      /// </summary>
      /// <returns></returns>
