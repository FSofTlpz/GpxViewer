...
#else
      protected PureImage GetTileImageUsingHttp(string url) => 
         ProviderHelper.GetTileImageUsingHttp(url, _authorization, RefererUrl,
                                              new System.Threading.CancellationTokenSource(5000)).Result;

      protected string GetContentUsingHttp(string url) =>
         ProviderHelper.GetContentUsingHttp(url, _authorization, RefererUrl,
                                            new System.Threading.CancellationTokenSource(5000)).Result;
