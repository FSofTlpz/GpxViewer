...
namespace SmallMapControl {
   ...
   public class Track {
      ...
      /// <summary>
      /// anzuzeigender Name (i.A. Trackname + Beschreibung)
      /// </summary>
      public string VisualName { get; protected set; }
      ...
      public bool IsVisible {
         get {
            return VisualTrack != null && VisualTrack.IsVisible;
         }
         set {
            if (VisualTrack != null)
      ...
      /// <summary>
      /// liefert den akt. Index der <see cref="Track"/> in <see cref="PoorGpxAllExt"/>
      /// </summary>
      /// <returns></returns>
      public int GpxDataContainerIndex {
         get {
            return GpxDataContainer != null ?
                           GpxDataContainer.TrackList.IndexOf(this) :
                           -1;
         }
      }
      ...
      public Color LineColor {
         get {
            return _lineColor;
            //return Visualtrack != null ? Visualtrack.Color : _lineColor;
         }
         set {
            if (_lineColor != value) {
               _lineColor = value;
      ...
      public double LineWidth {
         get {
            return _lineWidth;
            //return Visualtrack != null ? Visualtrack.Width : _lineWidth;
         }
         set {
            _lineWidth = value;
            setVisualStyle();
      ...
      /// <summary>
      /// Autom. Refresh beim Ändern von (einigen) Eigenschaften?
      /// </summary>
      public bool AutoRefreshIsActive { get; set; } = true;
      ...
      /// <para>Es gibt keinen Verweis auf einen <see cref="PoorGpxAllExt"/>.</para>
      /// </summary>
      /// <param name="visualname"></param>
      public Track(string visualname) {
         SetVisualname(visualname);
      ...
      /// <summary>
      /// erzeugt den <see cref="Track"/> mit diesen Daten, fügt ihn aber noch nicht ihn die Trackliste in <see cref="PoorGpxAllExt"/> ein
      /// </summary>
      ...
      /// <param name="visualname"></param>
      /// <returns></returns>
      public static Track Create(PoorGpxAllExt gpx, int trackno, int segmentno, string visualname) {
      ...
      /// <summary>
      /// erzeugt eine Kopie des <see cref="Track"/>, fügt ihn aber noch nicht ihn die Trackliste in <see cref="PoorGpxAllExt"/> ein
      /// </summary>
      /// <param name="orgtrack"></param>
      /// <param name="destgpx"></param>
      /// <returns></returns>
      public static Track CreateCopy(Track orgtrack, PoorGpxAllExt destgpx = null) {
      ...
      public void SetVisualname(string name) {
         VisualName = name;
      }
      ...
      public double Length() {
         return GpxSegment != null ? Length(0, GpxSegment.Points.Count - 1) : 0;
      }
      ...
      ///// <summary>
      ///// die Sichtbarkeit dieses <see cref="Track"/> ist die gleiche wie die aller anderen <see cref="Track"/> im gleichen <see cref="GpxDataContainer"/>
      ///// </summary>
      ///// <param name="mapControl"></param>
      ///// <returns></returns>
      //public bool TrackVisibilityIsSameLikeContainerVisibility(SmallMapCtrl mapControl) {
      //   if (GpxDataContainer != null) {
      //      if (GpxDataContainer.TrackList.Count == 0)
      //         return true;

      //      List<Track> lst = mapControl.MapGetVisibleTracks(false);
      //      bool isin = lst.Contains(GpxDataContainer.TrackList[0]);      // 1. Track
      //      for (int i = 1; i < GpxDataContainer.TrackList.Count; i++)
      //         if (lst.Contains(GpxDataContainer.TrackList[i]) != isin)
      //            return false;
      ...
      /// <summary>
      /// liefert den <see cref="VisualTrack.VisualStyle"/> für den akt. Zustand, unterschied aber nicht die verschiedenen Standardformen
      /// </summary>
      /// <returns></returns>
      ...
      public void UpdateVisualTrack(SmallMapCtrl mapControl = null) {
         bool visible = IsVisible;

         if (mapControl != null)
            mapControl.MapShowTrack(this, false, null); // ev. vorhandenen VisualTrack aus dem Control entfernen
         ...
         if (mapControl != null &&
            ...
            mapControl.MapShowTrack(this,
                                    true,
                                    IsEditable && GpxDataContainer != null ?
                                             GpxDataContainer.NextVisibleEditableTrack(this) :
                                             null);
         }
      }
