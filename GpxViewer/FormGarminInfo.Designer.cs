namespace GpxViewer {
   partial class FormGarminInfo {
      ...
      private void InitializeComponent() {
         ...
         listBox_Info.DrawMode = DrawMode.OwnerDrawVariable;
         listBox_Info.FormattingEnabled = true;
         listBox_Info.IntegralHeight = false;
         listBox_Info.Location = new Point(0, 0);
         listBox_Info.Margin = new Padding(4);
         listBox_Info.Name = "listBox_Info";
         listBox_Info.Size = new Size(379, 178);
         listBox_Info.TabIndex = 1;
         listBox_Info.DrawItem += listBox_Info_DrawItem;
         listBox_Info.MeasureItem += listBox_Info_MeasureItem;
         // 
         // contextMenuStrip1
         // 
         ...
         Name = "FormGarminInfo";
         ShowInTaskbar = false;
         Text = "Objektinfo für Garminkarte";
